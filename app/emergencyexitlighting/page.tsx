...
import FireFaqMap from "../components/fireFAQmap/FireFaqMap";
import Form from "../ui/form/Form";

export const metadata = {
    title: "Emergency / Exit Lighting",
    description: "Elite Brothers Fire provides expert exit and emergency lighting installation, maintenance, and verification to keep your business safe and compliant.",
    keywords:
