...
const Form = ({ handleSubmit }: FormProps) => {
    const inputClass = "w-full lg:w-1/2 rounded-md bg-white placeholder:text-neutral-500 outline-none border-b-2 p-1.5";
    const fullInputClass = "w-full rounded-md bg-white placeholder:text-neutral-500 outline-none border-b-2 p-1.5";
    ...
    return (
        ...
        >
            ...
            <textarea required className="w-full placeholder:text-neutral-500 min-h-48 rounded-md p-1.5 outline-none resize-none" placeholder="How can we Help you?*"></textarea>
