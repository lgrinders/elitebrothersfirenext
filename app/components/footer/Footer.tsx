...
const Footer = () => {
  return (
    <div className="dark flex w-full flex-col justify-center gap-10 border-t-4 border-t-EliteOrange bg-neutral-100 px-10 py-10 text-black sm:grid sm:grid-cols-2 md:grid-cols-3 lg:gap-20 lg:px-14 xl:flex xl:flex-row dark:bg-neutral-900 dark:text-white">
      <Logo />
