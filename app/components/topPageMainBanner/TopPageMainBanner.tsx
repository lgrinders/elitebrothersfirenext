...
const TopPageMainBanner = () => {
  ...
  return (
    <section className="flex items-center justify-between bg-neutral-200 p-4 font-semibold dark:bg-neutral-800">
      <div className="hidden w-1/3 md:block"></div>
      <div className="flex items-center justify-center md:w-1/3">
        <Logo />
      </div>

      <section className="hidden w-1/3 justify-center text-xs md:flex">
        <a
